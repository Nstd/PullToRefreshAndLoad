 ...
 */
public class PullableRecycleViewLinearActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        try {
            ...
            recyclerView.setAdapter(adapter = new RefreshRecycleAdapter(this, RefreshRecycleAdapter.LAYOUT_TYPE_LINEAR));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
