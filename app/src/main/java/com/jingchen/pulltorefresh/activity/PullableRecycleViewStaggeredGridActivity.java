...
/**
 * Created by maoting on 2016/4/29.
 */
public class PullableRecycleViewStaggeredGridActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        try {
            ...
            recyclerView.setAdapter(adapter = new RefreshRecycleAdapter(this, RefreshRecycleAdapter.LAYOUT_TYPE_STAGGERED_GRID));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
